...
def main():
    ...
    model = build_model()
    model.compile(
        optimizer=tf.keras.optimizers.Adam(1e-4),  # küçük LR şart
    ...
    model.save("../models/mobilenetv2_finetune_mnist.keras")
    print("Saved: ../models/mobilenetv2_finetune_mnist.keras")
